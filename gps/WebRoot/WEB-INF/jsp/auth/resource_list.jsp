	...
	<script type="text/javascript">
		...
		function loadOrInitButtonResourceDatagrid() {
			...
			$('#resourceDatagrid').datagrid({
				...
				columns:[[
					{field:'menuCode',title:'功能按钮编码',width:$$.fillsize(0.1,$$.getDatagridWidth()-300),align:'center'},
					{field:'menuName',title:'功能按钮名称',width:$$.fillsize(0.1,$$.getDatagridWidth()-300),align:'center'},
					{field:'menuMark',title:'功能按钮备注',width:$$.fillsize(0.1,$$.getDatagridWidth()-300),align:'center'},
					{field:'menuUrl',title:'菜单地址配置',width:$$.fillsize(0.65,$$.getDatagridWidth()-300),align:'center'}
				]],
