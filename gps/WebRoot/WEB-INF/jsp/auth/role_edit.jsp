...
<html>
  ...
  <body >
	   	<form action="#" id="editForm" style="display: inline;" class="tab">
    		<div style="display:none;"><input id="roleId" type="text" name="roleId" field="roleId" class="easyui-textbox" /></div>
    		<table width="99%" border="0" cellspacing="0" cellpadding="0">
   				<tr>
   					...
   					<td align="left">
   						<input id="roleName" type="text" name="roleName" field="roleName" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]','unnormal']"/>
   					</td>
   				</tr>
   				<tr>
   					...
   					<td align="left">
   						<input id="roleMark" type="text" name="roleMark" field="roleMark" class="easyui-textbox" data-options="required:false,validType:['maxLength[100]','unnormal']"/>
   					</td>
   				</tr>
