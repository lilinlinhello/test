...
public class StringUtil {
	...
	public static String formatCarlineType(String carLineType){
		String linetype = "";
		if("1".equals(carLineType)){
			linetype = "主干线";
		}else if("2".equals(carLineType)){
			linetype = "支干线";
		}else if("5".equals(carLineType)){
			linetype = "省内主干线";
		}else if("6".equals(carLineType)){
			linetype = "省内支干线";
		}else if("8".equals(carLineType)){
			linetype = "省内补助线";
		}else if("9".equals(carLineType)){
			linetype = "省内卡班线";
		}else if("10".equals(carLineType)){
			linetype = "物流线";
		}
		return linetype;
	}
