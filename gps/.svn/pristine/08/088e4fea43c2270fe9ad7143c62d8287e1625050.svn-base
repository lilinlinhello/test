	   	...
	   	<form action="#" id="editForm" style="display: inline;" class="tab">
   			<table width="99%" border="0" cellspacing="0" cellpadding="0">
   				...
   				<tr>
   					...
   					<td align="left">
   						<input id="menuCode" type="text" name="menuCode" field="menuCode" class="easyui-textbox" readonly="readonly" data-options="required:true,validType:['maxLength[25]','unnormal']"/>
   					</td>
   				</tr>
   				<tr>
   					...
   					<td align="left">
   						<input id="menuName" type="text" name="menuName" field="menuName" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]','unnormal']"/>
   					</td>
   				</tr>
   				<tr>
   					...
   					<td align="left">
   						<input id="menuMark" type="text" name="menuMark" field="menuMark" class="easyui-textbox" data-options="required:false,validType:['maxLength[100]','unnormal']"/>
   					</td>
   				</tr>
   					<tr>
					...
					<td align="left">
						<input  id="menuUrl"type="text" name="menuUrl" field="menuUrl" class="easyui-textbox" style="width:180px;height:60px;"
							data-options="multiline:true,validType:['maxLength[500]','space']" />
							&nbsp;&nbsp;&nbsp;<font style="color: red">注:URL以逗号隔开</font>
					</td>
   				</tr>
   			</table>
   		</form>
