...
public class StaticVar  implements Serializable {
	...
	//权限
	//不需要走权限校验的ACTION
	public static  String ANONYMOUS_ACTIONNAME = "anonymous.actionName" ;
	
	//rabbitMQ配置文件
	public static  String RABBITMQ_URL ;
	...
	static{
		...
		try {
			...
			ANONYMOUS_ACTIONNAME = props.getProperty("anonymous.actionName") ;
			
			//读取rabbitMQ配置文件
			RABBITMQ_URL = props.getProperty("rabbitMQ.url") ;
			RABBITMQ_USERNAME = props.getProperty("rabbitMQ.username") ;
	...
	//全局省市区名称 map
	public static final String GLOBAL_PROVINCE_MAP = "yunda.application.province.map";
	public static final String GLOBAL_CITY_MAP = "yunda.application.city.map";
	public static final String GLOBAL_COUNTY_MAP = "yunda.application.county.map";
