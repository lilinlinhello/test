	...
	<script type="text/javascript">
		$(function(){
		    ...
		    $("#addButton").bind("click", function(){
		    	$$.openJcdfDialog(basePath+'/auth/role.do?method=forwardAddJsp', '角色新增', 330, 620);
		    });
		    ...
		    $("#editButton").bind("click", function(){
				...
				if (null != selectRow) {
					$$.openJcdfDialog(basePath+'/auth/role.do?method=forwardEditJsp&roleId='+selectRow.roleId, '角色修改', 330, 620);
				}
		    });
		     //删除按钮单击事件
        	...
        	<form action="#" name="searchForm" id="searchForm" style="display: inline;">
        		<table class="searchArea">
				  <tr>
				    <td>角色名称：</td>
				    <td>
				    	<input name="roleName" type="text" class="easyui-textbox" data-options="validType:['unnormal']">
				    </td>
				  </tr>
			 	</table>
