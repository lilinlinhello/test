	   	...
	   	<form action="#" id="addForm" style="display: inline;" class="tab">
    		...
    		<table width="99%" border="0" cellspacing="0" cellpadding="0">
   				...
   				<tr>
   					...
   					<td align="left">
   						<input type="text" name="menuCode" field="menuCode" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]','unnormal']"/>
   					</td>
   				</tr>
   				<tr>
   					...
   					<td align="left">
   						<input type="text" name="menuName" field="menuName" class="easyui-textbox" data-options="required:true,validType:['maxLength[25]','unnormal']"/>
   					</td>
   				</tr>
   				<tr>
   					<td class="bule" align="right">
   					...
   					<td align="left">
   						<input type="text" name="menuMark" field="menuMark" class="easyui-textbox" data-options="required:false,validType:['maxLength[100]','unnormal']"/>
   					</td>
   				</tr>
   				<tr>
   					<td class="bule" align="right">
					...
					<td align="left">
						<input  type="text" name="menuUrl" field="menuUrl" class="easyui-textbox" style="width:180px;height:60px;"
